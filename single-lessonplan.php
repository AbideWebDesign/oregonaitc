						...
						<div class="card bg-primary mb-3">
							...
							<div class="card-body">
								...
								<?php if ( get_field('lesson_plan_pdf') ): ?>
									...
									<p class="text-center m-0"><a target="_blank" href="<?php the_field('lesson_plan_pdf'); ?>" class="btn btn-white btn-sm btn-block" data-gaevent="Lesson Plans,Download,<?php the_title(); ?>"><i class="fa fa-download"></i> Download PDF</a></p>
								
								<?php endif; ?>
								
								<?php if ( get_field('lesson_plan_pdf_sp') ): ?>
								
									<p class="text-center mt-1 mb-0"><a target="_blank" href="<?php the_field('lesson_plan_pdf_sp'); ?>" class="btn btn-white btn-sm btn-block" data-gaevent="Lesson Plans,Download,<?php the_title(); ?> - SP"><i class="fa fa-download"></i> Download PDF (Spanish)</a></p>
								...
								<?php $image = get_field('image_1');  ?>
									...
									<div class="d-flex">
										...
										<div class="mr-2 align-self-center">
											...
											<a data-fancybox href="<?php echo $image['url']; ?>"><?php echo wp_get_attachment_image($image['id'], 'col-7', 0, array('class' => 'img-fluid')); ?></a>
